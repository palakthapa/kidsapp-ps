                ...
                <div className="fixed z-10 inset-0 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen px-4">
                        ...
                        <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                            <div>
                                <h1 className="text-2xl font-bold px-4 py-2 sm:px-6">Please select input type</h1>
                            <button
                                className="absolute top-2 right-4 w-full rounded-md px-4 py-2 bg-gray-100 text-gray-700 hover:bg-danger hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm"
                            ...
                            <div className="bg-white flex justify-between px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className='w-[32%] h-[150px]'>
                                    <div className="relative w-full h-full text-white bg-aqua rounded-2xl px-5 overflow-hidden">
                                        <h2 className="text-3xl font-semibold mt-2">Key-Board</h2>
                                        <button className="absolute text-lg text-aqua bg-white py-2 px-8 rounded-full bottom-3 left-4" onClick={() => { navigateToLearningScreen("kb") }}>Start</button>
                                ...
                                <div className='w-[32%] h-[150px]'>
                                    <div className="relative w-full h-full text-white bg-pink rounded-2xl px-5 overflow-hidden">
                                        <h2 className="text-3xl font-semibold mt-2">Drag &amp; Drop</h2>
                                        <button className="absolute text-lg text-pink bg-white py-2 px-8 rounded-full bottom-3 left-4" onClick={() => { navigateToLearningScreen("dnd") }}>Start</button>
                                ...
                                <div className='w-[32%] h-[150px]'>
                                    <div className="relative w-full h-full text-white bg-purple rounded-2xl px-5 overflow-hidden">
                                        <h2 className="text-3xl font-semibold mt-2">Draw</h2>
                                        <button className="absolute text-lg text-purple bg-white py-2 px-8 rounded-full bottom-3 left-4" onClick={() => { navigateToLearningScreen("dr") }}>Start</button>
