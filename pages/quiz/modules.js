  ...
  return (
    <Layout title="Quiz Modules">
      <div className='w-4/5 m-auto'>
            ...
            <div className='w-4/5 sm:w-3/4 md:w-1/2 flex flex-wrap justify-around mx-auto'>

                <div className="relative w-4/5 sm:w-[48%] h-[150px] text-aqua bg-aqua rounded-2xl px-5 overflow-hidden mb-3">
                ...
                <div className="relative w-4/5 sm:w-[48%] h-[150px] text-green bg-green rounded-2xl px-5 overflow-hidden mb-3">
